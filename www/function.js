var versi = "1";
var url = "https://keyzie.web.id/app/";
var url_admin = "https://keyzie.web.id/";
var api_ongkir = "https://ongkir.tokojs.com/api_ongkir/";

var token='6KB4J3xGZX';
var nama_aplikasi='Keyzie Fashion Shop';
...
if (id_pelanggan !=null){
	$.ajax({url: url+'/cek_notif?act='+act+'&token='+token+'&id_pelanggan='+id_pelanggan,
		success: function(result){
        	if(act=='keranjang'){
        		if(result>0){$(".icon_keranjang").attr("src","image/keranjang_2.png");$("#x-cart").show();
				}
        		else {$(".icon_keranjang").attr("src","image/keranjang.png");$("#x-cart").hide();}
        	}         	
        	else if(act=='info'){
